...
./node_modules/terser/bin/terser -o n-carousel.min.js --compress --mangle -- n-carousel.rollup.js
rm n-carousel.rollup.js
./node_modules/terser/bin/terser -o n-carousel-preload.min.js --compress --mangle -- n-carousel-preload.js
